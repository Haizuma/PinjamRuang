                        ...
                        <div class="row no-gutters slider-text align-items-center justify-content-center">
                            <div class="col-md-9 text-center text-white">
                                <p class="breadcrumbs mb-2">
                                    <span class="mr-2"><a href="{{ route('home') }}" class="text-white">Beranda <i class="fa fa-chevron-right"></i></a></span>
                                            ...
                                            <div class="form-row align-items-end">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="room_id" class="form-control">
                                                        ...
                                                        @foreach ($data['all_rooms'] as $room_option)
                                                            <option value="{{ $room_option->id }}" @if(request('room_id') == $room_option->id) selected @endif>
                                                                {{ $room_option->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="input-group date" id="date_picker" data-target-input="nearest">
                                                        <input type="text" name="selected_date" class="form-control datetimepicker-input" data-target="#date_picker" placeholder="Pilih tanggal" value="{{ request('selected_date') }}">
                                                                                        ...
                                                                                        <div class="col-md-10 mb-4">
                                                                                            <div class="card border-0 shadow-sm">
                                                                                                ...
                                                                                                <div class="card-body text-center">
                                                                                                    ...
                                                                                                    <a class="btn btn-outline-secondary btn-sm px-3" data-toggle="collapse" href="#schedule-{{ $room->id }}" role="button" aria-expanded="false" aria-controls="schedule-{{ $room->id }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group date" id="until_at_picker_modal" data-target-input="nearest">
                                            <input name="until_at" value="{{ old('until_at') }}" type="text"
                                                ...
                                                data-target="#until_at_picker_modal" />
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select name="unit_kerja" class="form-control">
                                            ...
                                            <option value="bidang-pembinaan-smk" @if(old('unit_kerja') == 'bidang-pembinaan-smk')
                                            selected @endif>Bidang Pembinaan SMK</option>
                                            <option value="bidang-pembinaan-sma" @if(old('unit_kerja') == 'bidang-pembinaan-sma')
                                            selected @endif>Bidang Pembinaan SMA</option>
                                            ...
                                            <option value="bidang-subbag-kepegawaian"
                                                ...
                                                Kepegawaian</option>
                                            <option value="bidang-subbag-keuangan" @if(old('unit_kerja') == 'bidang-subbag-keuangan')
                                            selected @endif>Bidang Subbag Keuangan</option>
                                            <option value="bidang-subbag-umum" @if(old('unit_kerja') == 'bidang-subbag-umum') selected
                                            @endif>Bidang Subbag Umum</option>
                                        </select>
                                    </div>
                                    <!-- Catatan -->
...
@push('scripts')
    <script>
        $(function () {
            ...
            borrowAtPicker.datetimepicker({ format: 'DD-MM-YYYY HH:mm' });
            untilAtPicker.datetimepicker({ format: 'DD-MM-YYYY HH:mm', useCurrent: false });
